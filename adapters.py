...
def train(experiment_name, model_name, dataset_name, adapter_name, checkpoint, batch_size_train, batch_size_test, epochs, max_length, max_new_tokens, rank):
    # Get Model classes
    ...
    output_path.replace("/", "-")
    output_path = f"models/{adapter_name}/{dataset_name}/{model_name}/{output_path}_{rank}/"
